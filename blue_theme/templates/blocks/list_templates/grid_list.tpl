{if $products}
                ...
                {foreach from=$sproducts item="product" name="sproducts"}
                    <div class="ty-column{$columns}">
                        {if $product}
                            ...
                            <div class="ty-grid-list__item vr-product ty-quick-view-button__wrapper 
                                ...
                                {hook name="products:product_multicolumns_list"}
										...
										{if $product.amount>0} <p class="vr-amount">{__('in_stock')}</p>{/if}
	...
	<p class="vr-text-center"><a href="#" id="vr-show_more_products" class="vr-black-btn">{__('show_more')}</a></p>
